...
const dummy_movies = [
  {
    id: 1,
    image:
      "https://static.toiimg.com/thumb/msid-61267668,width-219,height-317,imgsize-112648/61267668.jpg",
  ...
  },
  {
    id: 2,
    image:
      "https://th-thumbnailer.cdn-si-edu.com/g4NQdvJN8yzJLEDQPeEGbfNLJj0=/1400x1050/filters:focal(800x602:801x603)/https://tf-cmsv2-smithsonianmag-media.s3.amazonaws.com/filer_public/90/da/90daa208-2dcf-42ed-b2c5-05ce8d306a03/untitled-2.jpg",
    name: "The Godfather",
    year: 1972,
    genre: "crime",
...
function App() {
  ...
  return (
    <div className="App">
      <NewMovie onAddMovie={addMovieHandler}></NewMovie>
      <Movies items={movies} />
    </div>
  );
}
